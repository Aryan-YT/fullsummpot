...
import { mockAuthApi, mockPointsApi } from '../services/mockApi';
...
export default function ProfilePage() {
  ...
  const { data: profile } = useQuery({
    ...
    queryFn: () => mockAuthApi.me(userId).then((r) => r.data),
    enabled: !!userId,
  });
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-3 gap-4 pt-4 border-t border-border">
          <div className="text-center">
            ...
            <p className="text-xl font-bold text-textPrimary">{points?.availablePoints ?? 0}</p>
          ...
          <div className="text-center">
            ...
            <p className="text-xl font-bold text-textPrimary">{points?.pointsEarnedToday ?? 0}</p>
          ...
          <div className="text-center">
            ...
            <p className="text-xl font-bold text-textPrimary">{points?.viewsGivenToday ?? 0}</p>
      ...
      <div className="card">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-textPrimary font-medium">{displayUser?.niche}</span>
          </div>
